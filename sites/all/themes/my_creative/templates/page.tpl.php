  ...
  <div class="layout-978">
    ...
    <div class="featured-slider">
      <div class="slides displayblock">
        <div class="featured">
          <div class="slide-image"><span class="img-effect pngfix"></span><img src="<?php print base_path() . drupal_get_path('theme', 'creative') . '/images/slide-image-1.jpg'; ?>" class="pngfix"/>
          </div> <!-- .slide-image -->
        </div> <!-- .featured -->
